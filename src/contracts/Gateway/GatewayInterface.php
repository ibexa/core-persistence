...
interface GatewayInterface
{
    ...
    /**
     * @param \Doctrine\Common\Collections\Expr\Expression|array<array-key, scalar|array<scalar|\Stringable>|\Stringable|\Doctrine\Common\Collections\Expr\Expression> $criteria $criteria
     */
    ...
    /**
     * @param \Doctrine\Common\Collections\Expr\Expression|array<array-key, scalar|array<scalar|\Stringable>|\Stringable|\Doctrine\Common\Collections\Expr\Expression> $criteria  Map of column names to values that will be used as part of WHERE query
    ...
    /**
     * @param array<array-key, scalar|array<scalar|\Stringable>|\Stringable|\Doctrine\Common\Collections\Expr\Expression> $criteria  Map of column names to values that will be used as part of WHERE query
     * @param array<string, string>|null $orderBy Map of column names to "ASC" or "DESC", that will be used in SORT query
     *
     * @phpstan-param array<string, "ASC"|"DESC">|null $orderBy
     *
